...
LIBS=-lpthread
OBJECTS=src/fnf.o src/match.o src/tty.o src/choices.o src/options.o src/tty_interface.o src/colors.o src/selections.o
THEFTDEPS = deps/theft/theft.o deps/theft/theft_bloom.o deps/theft/theft_mt.o deps/theft/theft_hash.o
TESTOBJECTS=test/fnftest.c test/test_properties.c test/test_choices.c test/test_match.c src/match.o src/choices.o src/options.o src/tty_interface.o src/tty.o src/colors.o src/selections.o $(THEFTDEPS)
